...
# check for winner, draw or continue the game
def play(x,y):
    global turn
    i = 3-int(y+5)//2
    j = int(x+5)//2 - 1
    ...
    if r==1:
        ...
        sketch.goto(0, 3)
        sketch.write("X WINS !",
            align="center", font=("Courier", 100, "normal"))
    elif r==2:
        sketch = turtle.Turtle()
        sketch.speed(0)
        sketch.color("black")
